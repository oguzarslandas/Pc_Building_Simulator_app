...
class BestPriceGpuPage extends StatefulWidget {
  const BestPriceGpuPage({
    Key? key,
  }) : super(key: key);

  @override
  State<BestPriceGpuPage> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<BestPriceGpuPage> {
